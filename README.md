...
### Frontend
![Angular](https://img.shields.io/badge/Angular_8+-DD0031?style=flat-square&logo=angular&logoColor=white)
...
### AI / ML
![RAG](https://img.shields.io/badge/RAG_Systems-412991?style=flat-square&logo=openai&logoColor=white)
...
```
Cisco Systems          Software Consulting Engineer         Apr 2021 — Present
Infosys Ltd.           Senior Associate Consultant          May 2019 — Apr 2021
Mindtree Ltd.          Senior Software Engineer             Jan 2018 — May 2019
Saptalabs Pvt. Ltd.    Software Engineer                    Apr 2017 — Dec 2017
```
...
### AIOps & RAG Intelligence
**@ Cisco Systems**

AI-powered operations platform with intelligent knowledge retrieval and predictive analytics.

`Python` `FastAPI` `RAG` `LangChain` `AI/ML`

> **85%** context retrieval accuracy · **40%** faster incident resolution

</td>
<td width="50%">

### Bank of America BPA Platform
**@ Cisco Systems**

Enterprise business process automation for banking operations.

`Angular` `Node.js` `Python` `MongoDB` `Docker`

> **50%** reduction in manual processing · Improved compliance
...
### Enterprise MEAN Stack Apps
**@ Infosys**

Scalable web applications serving 50K+ concurrent users.

`MongoDB` `Express.js` `Angular` `Node.js`

> **35%** performance improvement · **95%** customer satisfaction

</td>
<td width="50%">

### FT-USDE Mutual Funds Platform
**@ Mindtree**

Dashboard for financial advisors to manage client portfolios.

`Angular` `Node.js` `MongoDB`

> Built for financial services industry
...
|------|-------|-------------|
| 2023 | **Excellence in Innovation** | Cisco Systems |
| 2020 | **Outstanding Performance** | Infosys |
| 2019 | **Best Technical Contributor** | Mindtree |
| 2018 | **Team Leadership Award** | Mindtree |
